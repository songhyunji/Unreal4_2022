...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AVictoryBox_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AVictoryBox_OnBeginOverlap, "OnBeginOverlap" }, // 2801193477
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AVictoryBox, 3517928053);
	template<> DODGEBALL_API UClass* StaticClass<AVictoryBox>()
	{
		return AVictoryBox::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AVictoryBox(Z_Construct_UClass_AVictoryBox, &AVictoryBox::StaticClass, TEXT("/Script/Dodgeball"), TEXT("AVictoryBox"), false, nullptr, nullptr, nullptr);
